    ...
    <div className="flex flex-col  w-full h-full text-light-black2 p-5 ">
      ...
      <div className="flex justify-center p-20 ">
        <div className=" flex flex-wrap  sm:flex-col   lg:w-5/6  xxl:w-2/3 3xl:w-2/3 4xl:w-2/3 justify-center ">
          {/* 1 */}
          <div className="flex  flex-col p-20 sm:p-10 sm:w-full lg:w-full lg:p-10 w-1/2 gap-2  border-r-2 border-b-2  sm:border-none md:border-none lg:border-none">
            <div className="">
          ...
          {/* 2 */}
          <div className="flex p-20 sm:p-10 sm:w-full lg:w-full lg:p-10 flex-col w-1/2  gap-2 border-b-2  sm:border-none md:border-none lg:border-none">
            <div className="">
          ...
          {/* 3 */}
          <div className="flex p-20 sm:p-10 sm:w-full lg:w-full lg:p-10 flex-col w-1/2  gap-2   sm:border-none md:border-none lg:border-none  border-r-2">
            <div className="">
          ...
          {/* 4 */}
          <div className="flex sm:p-10 sm:w-full lg:w-full lg:p-10 sm:border-none w-1/2 p-20 flex-col  gap-2   ">
            <div className="">
